...
public final class BZip2InputStream {
	...
	public static int method225(byte[] abyte0, int i, byte[] abyte1, int j, int k) {
		synchronized (BZIP_DECOMPRESSION_STATE) {
			BZIP_DECOMPRESSION_STATE.aByteArray563 = abyte1;
			BZIP_DECOMPRESSION_STATE.anInt564 = k;
			BZIP_DECOMPRESSION_STATE.aByteArray568 = abyte0;
			BZIP_DECOMPRESSION_STATE.anInt569 = 0;
			BZIP_DECOMPRESSION_STATE.anInt565 = j;
			BZIP_DECOMPRESSION_STATE.anInt570 = i;
			BZIP_DECOMPRESSION_STATE.anInt577 = 0;
			BZIP_DECOMPRESSION_STATE.anInt576 = 0;
			BZIP_DECOMPRESSION_STATE.anInt566 = 0;
			BZIP_DECOMPRESSION_STATE.anInt567 = 0;
			BZIP_DECOMPRESSION_STATE.anInt571 = 0;
			BZIP_DECOMPRESSION_STATE.anInt572 = 0;
			BZIP_DECOMPRESSION_STATE.anInt579 = 0;
			method227(BZIP_DECOMPRESSION_STATE);
			i -= BZIP_DECOMPRESSION_STATE.anInt570;
			return i;
		}
	}
	...
	private static final BZip2DecompressionState BZIP_DECOMPRESSION_STATE = new BZip2DecompressionState();
